...
export const pagesContent = {
  home: {
    metadata: {
      ...
      description: 'Explore premium media distribution, featured announcements, and the latest public-facing releases in one polished newsroom experience.',
      openGraphTitle: 'Press release distribution and media visibility',
      openGraphDescription: 'Browse featured releases, discover recent coverage, and explore premium distribution content designed for modern media visibility.',
      keywords: ['press release distribution', 'media visibility', 'release archive', 'news distribution'],
    },
    hero: {
      badge: '',
      title: ['Get published across', 'media-ready distribution channels.'],
      description: 'Position announcements, product launches, public statements, and campaign updates in a premium newsroom built for reach, clarity, and discoverability.',
      primaryCta: { label: 'Submit a release', href: '/create' },
      secondaryCta: { label: 'View latest releases', href: '/updates' },
      searchPlaceholder: 'Search announcements, companies, topics, and releases',
      focusLabel: 'Coverage focus',
      featureCardBadge: 'featured release',
      featureCardTitle: 'Premium placement for the stories that need visibility now.',
      featureCardDescription: 'Lead releases, spotlight updates, and supporting stories stay coordinated inside a cleaner editorial presentation.',
    },
    intro: {
    ...
    cta: {
      badge: 'Grow your visibility',
      title: 'Open a cleaner distribution path for your next announcement.',
      description: 'From product news to executive updates, publish into a branded experience that keeps every release polished, searchable, and ready to circulate.',
      primaryCta: { label: 'Submit Release', href: '/create' },
